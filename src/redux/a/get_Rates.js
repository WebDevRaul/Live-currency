...
import { GET_TODAY, GET_YESTERDAY, GET_LAST_YEAR, GET_ERRORS, GET_EXCHANGE_YESTERDAY, GET_EXCHANGE_LAST_YEAR, GET_FAKE_DATE } from '../actions/types';
        ...
        axios
          ...
          .then(res => {
            ...
            if (isEmpty(res.data.rates)) {
              ...
              axios
                .get(`https://api.exchangeratesapi.io/history?start_at=${date.secondDayBeforeLastYear}&end_at=${date.secondDayBeforeLastYear}&symbols=${symbols}&base=${base}`)
                .then(res => {
                  if (isEmpty(res.data.rates)) {
                    dispatch({
