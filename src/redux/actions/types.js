...
export const GET_EXCHANGE_YESTERDAY = 'GET_EXCHANGE_YESTERDAY';
export const GET_EXCHANGE_LAST_YEAR = 'GET_EXCHANGE_LAST_YEAR';
export const GET_EXCHANGE_NEW_TODAY = 'GET_EXCHANGE_NEW_TODAY';
export const GET_EXCHANGE_NEW_YESTERDAY = 'GET_EXCHANGE_NEW_YESTERDAY';
export const GET_EXCHANGE_NEW_LAST_YEAR = 'GET_EXCHANGE_NEW_LAST_YEAR';
export const GET_FAKE_DATE = 'GET_FAKE_DATE';
export const GET_EXCHANGE_TODAY = 'GET_EXCHANGE_TODAY';